    ...
    static double[] getLowPass(Wavelet wavelet, int order) {
        ...
        if (wavelet == Wavelet.Daub1) {
            switch (order) {
                ...
                case 3: {
                    double[] f = {0.47046721,1.14111692,0.650365,
                ...
                case 4: {
                    double[] f = {0.32580343,1.01094572,0.89220014,-0.03957503,
                ...
                case 5: {
                    double[] f = {0.22641898,0.85394354,1.02432694,0.19576696,-0.34265671,
                                    -0.04560113,0.10970265,-0.00882680,-0.01779187,0.00471743
                    };
                    return f;

                }
                case 6: {
                    double[] f = {0.15774243,0.69950381,1.06226376,0.44583132,
                                    -0.31998660,-0.18351806,0.13788809,0.03892321,
                                    -0.04466375,0.00078325,0.00675606,-0.00152353
                    };
                    return f;

                }
                case 7: {
                    double[] f = {0.11009943, 0.56079128,1.03114849,0.66437248,-0.20351382, -0.31683501,0.10084670,
                            0.11400345,-0.05378245,-0.02343994,0.01774979, 0.00060751,-0.00254790,0.00050023
                    };
                    return f;

                }
                case 8: {
                    double[] f = {0.07695562,0.44246725,0.95548615,0.82781653,
                            -0.02238574,-0.40165863,0.00066819,0.18207636,
                            -0.02456390,-0.06235021,0.01977216,0.01236884,
                            -0.00688772,-0.00055400,0.00095523,-0.00016614
                    };
                    return f;

                }
                case 9: {
                    double[] f = {0.05385035,0.34483430, 0.85534906,0.92954571,0.18836955,-0.41475176,
                                    -0.13695355,0.21006834, 0.04345268, -0.09564726,0.00035489,0.03162417,
                                    -0.00667962,-0.00605496,0.00261297, 0.00032581, -0.00035633,0.00005565
                    };
                    return f;

                }
                case 10: {
                    double[] f = {0.03771716, 0.26612218,0.74557507,0.97362811,0.39763774,
                                    -0.35333620,-0.27710988,0.18012745, 0.13160299,-0.10096657,
                                    -0.04165925,0.04696981, 0.00510044,-0.01517900,0.00197333,
                                    0.00281769,-0.00096995, -0.00016471,0.00013235,-0.00001876
                    };
                    return f;
        ...
        if (wavelet == Wavelet.Daub2) {
            switch (order) {
                case 1: {
                    double[] f = {0.7071,0.7071};
                    return f;
        ...
        if (wavelet == Wavelet.Daub3) {
            switch (order) {
                case 1: {
                    double[] f = {0.5000, 0.5000};
                    return f;

                }
                case 2: {
                    double[] f = {0.3415, 0.5915,
                            0.1585, -0.0915};
                    return f;

                }
                case 3: {
                    double[] f = {0.2352, 0.5706, 0.3252,
                            -0.0955, -0.0604, 0.0249};
                    return f;

                }
                case 4: {
                    double[] f = {0.1629, 0.5055, 0.4461, -0.0198,
                            -0.1323, 0.0218, 0.0233, -0.0075};
                    return f;

                }
                case 5: {
                    double[] f = {0.1132, 0.4270, 0.5122, 0.0979, -0.1713,
                            -0.0228, 0.0549, -0.0044, -0.0089, 0.0024};
                    return f;

                }
                case 6: {
                    double[] f = {0.0789, 0.3498, 0.5311,
                            0.2229, -0.1600, -0.0918, 0.0689,
                            0.0195, -0.0223, 0.0004, 0.0034, -0.0008};
                    return f;

                }
                case 7: {
                    double[] f = {0.0550, 0.2804, 0.5156, 0.3322, -0.1018, -0.1584,
                            0.0504, 0.0570, -0.0269, -0.0117, 0.0089, 0.0003, -0.0013, 0.0003};
                    return f;

                }
                case 8: {
                    double[] f = {0.0385, 0.2212, 0.4777, 0.4139,
                            -0.0112, -0.2008, 0.0003, 0.0910,
                            -0.0123, -0.0312, 0.0099, 0.0062,
                            -0.0034, -0.0003, 0.0005, -0.0001};
                    return f;

                }
                case 9: {
                    double[] f = {0.0269, 0.1724, 0.4277, 0.4648, 0.0942, -0.2074,
                            -0.0685, 0.1050, 0.0217, -0.0478, 0.0002, 0.0158,
                            -0.0033, -0.0030, 0.0013, 0.0002, -0.0002, 0.00002};
                    return f;

                }
                case 10: {
                    double[] f = {
                            0.0189, 0.1331, 0.3728, 0.4868, 0.1988,
                            -0.1767, -0.1386, 0.0901, 0.0658, -0.0505,
                            -0.0208, 0.0235, 0.0026, -0.0076, 0.0010,
                            0.0014, -0.0005, -0.0001, 0.0001, -0.000009};
                    return f;
